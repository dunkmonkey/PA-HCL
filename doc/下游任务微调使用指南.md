...
**A**: 确保原始数据目录结构正确：
- CirCor: `data/raw/circor/training_data/` 和 `data/raw/circor/training_data.csv`
- PhysioNet 2016: `data/raw/physionet2016/training-*/` 和 `REFERENCE.csv`
...
python -c "
import librosa
audio, sr = librosa.load('data/raw/circor/training_data/10001_AV.wav')
